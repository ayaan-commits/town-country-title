            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-accent-500/10 rounded-lg flex items-center justify-center border border-accent-500/20">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${companyInfo.phone}`} className="text-accent-400 hover:text-accent-300">
                      {companyInfo.phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${companyInfo.email}`} className="text-accent-400 hover:text-accent-300">
                      {companyInfo.email}
                    </a>
                  </div>
                </div>
              ...
              {/* Map Placeholder */}
              <div className="mt-8">
                <h3 className="font-bold text-white mb-4">Find Us</h3>
                <div className="bg-dark-900 rounded-lg h-64 flex items-center justify-center border border-dark-700">
                  <div className="text-center text-gray-500">
                    <svg className="w-12 h-12 mx-auto mb-2 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                    </svg>
                    <p className="text-gray-400">Google Maps Integration</p>
                    <p className="text-sm text-gray-500">Pembroke Pines, FL</p>
                  </div>
                </div>
              </div>
            </div>
