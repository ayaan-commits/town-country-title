  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="absolute top-20 right-10 w-72 h-72 bg-gradient-to-br from-blue-400/30 to-indigo-400/30 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-gradient-to-br from-indigo-400/20 to-purple-400/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-br from-cyan-400/20 to-blue-400/20 rounded-full blur-3xl animate-pulse-soft"></div>

        <div className="container-custom py-20 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in-up">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-blue-100 text-sm text-blue-600 mb-8 animate-fade-in">
              ...
              <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-lg animate-fade-in-up delay-200">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-fade-in-up delay-300">
                <Link
                  href="/quote/"
                  className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 hover:-translate-y-1 hover:scale-105 btn-glow"
                >
                  Get Free Quote
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-700 font-semibold rounded-xl border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-300 hover:scale-105"
                >
              ...
              <div className="flex items-center gap-8 pt-8 border-t border-gray-200 animate-fade-in-up delay-400">
                <div className="text-center" ref={yearsCounter.ref}>
                  <div className="text-3xl font-bold text-gray-900">{yearsCounter.count}+</div>
                  <div className="text-sm text-gray-500">Years Experience</div>
                </div>
                <div className="w-px h-12 bg-gray-200"></div>
                <div className="text-center" ref={countiesCounter.ref}>
                  <div className="text-3xl font-bold text-gray-900">{countiesCounter.count}</div>
                  <div className="text-sm text-gray-500">FL Counties</div>
                </div>
                <div className="w-px h-12 bg-gray-200"></div>
                <div className="text-center" ref={ratingCounter.ref}>
                  <div className="flex items-center gap-1 justify-center">
                    <span className="text-3xl font-bold text-gray-900">{(ratingCounter.count / 10).toFixed(1)}</span>
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-xl shadow-blue-500/5 card-hover animate-fade-in-up delay-100">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center mb-4 animate-float">
                ...
                <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl p-6 text-white card-hover animate-fade-in-up delay-200" ref={closingsCounter.ref}>
              ...
              <div className="space-y-4 pt-8">
                <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-xl shadow-blue-500/5 card-hover animate-fade-in-up delay-300">
                  <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl flex items-center justify-center mb-4 animate-float" style={{ animationDelay: '0.5s' }}>
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 border border-white/50 shadow-xl shadow-blue-500/5 card-hover animate-fade-in-up delay-400">
                  <div className="w-12 h-12 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center mb-4 animate-float" style={{ animationDelay: '1s' }}>
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative">
          <div className="flex animate-marquee">
            {[...trustLogos, ...trustLogos].map((logo, i) => (
              <div
                key={i}
                className="flex-shrink-0 mx-8 px-6 py-3 bg-gray-50 rounded-lg border border-gray-100 hover:border-blue-200 hover:bg-blue-50 transition-all duration-300 cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center text-white font-bold text-xs">
                    {logo.abbrev.slice(0, 2)}
                  </div>
                  <span className="text-gray-700 font-medium whitespace-nowrap">{logo.name}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 bg-white" ref={servicesAnim.ref}>
        <div className="container-custom">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-[200px] transition-all duration-700 delay-200 ${servicesAnim.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <Link
              ...
              className="group md:col-span-2 md:row-span-2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 rounded-3xl p-8 flex flex-col justify-between text-white hover:shadow-2xl hover:shadow-blue-500/25 transition-all duration-500 hover:-translate-y-2"
            >
              <div>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white" ref={whyUsAnim.ref}>
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className={`transition-all duration-700 ${whyUsAnim.isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-start gap-4 p-4 bg-white rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer"
            ...
            {/* CTA Card - Glassmorphism with Animation */}
            <div className={`relative transition-all duration-700 delay-300 ${whyUsAnim.isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-3xl transform rotate-3 hover:rotate-6 transition-transform duration-500"></div>
              <div className="relative bg-white rounded-3xl p-8 md:p-10 shadow-2xl hover:shadow-3xl transition-shadow duration-300">
                <div className="absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-br from-yellow-400 to-orange-400 rounded-2xl flex items-center justify-center transform rotate-12 shadow-lg animate-float">
                ...
                <div className="space-y-4 mb-8">
                  {['Free, no-obligation quote', 'Transparent pricing', 'Expert consultation', 'Fast turnaround'].map((item, i) => (
                    <div key={i} className="flex items-center gap-3 group">
                      <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center group-hover:scale-110 group-hover:bg-green-200 transition-all duration-300">
                ...
                <Link
                  href="/quote/"
                  className="block w-full py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-center font-bold rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 hover:-translate-y-1 btn-glow"
                >
                  Request Free Quote
                </Link>
      ...
      <section className="py-24 bg-white" ref={areasAnim.ref}>
        <div className="container-custom">
          ...
          <div className={`grid grid-cols-2 md:grid-cols-4 gap-4 transition-all duration-700 delay-200 ${areasAnim.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {popularRegions.map((region, regionIndex) => (
              <div
                key={region.name}
                className="bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-2xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border border-gray-100 hover:border-blue-200"
          ...
          <div className={`text-center mt-12 transition-all duration-700 delay-400 ${areasAnim.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <Link
              href="/locations/"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 text-white font-semibold rounded-xl hover:bg-gray-800 hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
            >
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white" ref={testimonialsAnim.ref}>
        <div className="container-custom">
          ...
          <div className={`grid md:grid-cols-3 gap-6 transition-all duration-700 delay-200 ${testimonialsAnim.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {[
              ...
              <div
                key={i}
                className="bg-white rounded-2xl p-8 border border-gray-100 hover:border-blue-200 hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold group-hover:scale-110 transition-transform">
      ...
      <section className="py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-indigo-500/30 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }}></div>
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-blue-400/20 rounded-full blur-3xl animate-pulse-soft"></div>
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/quote/"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-blue-600 font-bold rounded-xl hover:shadow-xl hover:shadow-white/25 transition-all duration-300 hover:-translate-y-1 hover:scale-105"
            >
              Get Free Quote
            ...
            <a
              href={`tel:${companyInfo.phone}`}
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300 hover:-translate-y-1"
            >
