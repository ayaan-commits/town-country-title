        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">Title Guaranty</div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href={`tel:${companyInfo.phone}`} className="hover:text-primary-400 transition-colors">
                  {companyInfo.phone}
                </a>
              </p>
              <p className="flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/quote/" className="hover:text-primary-400 transition-colors">Get a Quote</Link></li>
              ...
              <li><Link href="/glossary/" className="hover:text-primary-400 transition-colors">Glossary</Link></li>
            ...
            <div className="mt-6">
              ...
              <p className="text-sm">{companyInfo.hours.weekdays}</p>
              <p className="text-sm">{companyInfo.hours.saturday}</p>
              <p className="text-sm">{companyInfo.hours.sunday}</p>
            </div>
          </div>
        </div>
      </div>
